...
<template>
  <div class="centerCard">
    <el-card shadow="hover">
      ...
      <div slot="header">
        <span class="fstrong f16">软装设计审核（广美财务）</span>
      </div>
      ...
      <div style="margin-top:10px">
        <el-table border :data="lanjuData" style="width: 100%" class="table_1">
          ...
          <el-table-column align="center" label="操作" width="100px">
            <template slot-scope="scope">
              <el-button v-if="scope.row.STATUS == 3" @click="_EditDetail(scope.row)" type="primary" size="mini"
                icon="el-icon-edit" circle></el-button>
              <el-button v-if="scope.row.STATUS != 3" @click="_CheckDetail(scope.row)" type="warning" size="mini"
