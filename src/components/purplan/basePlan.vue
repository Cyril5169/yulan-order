<template>
  <div class="safeStock">
    <el-card shadow="never">
      ...
      <hr />
      <el-table :data="stockData" height="530" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="供应商" prop="OEM_SUPPLY_ID" width="80" align="center"></el-table-column>
      </el-table>
    </el-card>
  </div>
</template>
